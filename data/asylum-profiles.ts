...
export const asylumProfiles: AsylumProfile[] = [
  {
    ...
    metaTitle: "Ahmadi Muslim Expert Report | Pakistan Asylum Evidence & CPIN 2025",
    metaDescription:
      "Ahmadi Muslim expert report for asylum tribunals. Ordinance XX 1984, TLP mob violence, March 2025 CPIN Version 6.0, MN and Others [2012], and Ahmadiyya verification.",
    h1: "Ahmadi Muslim Expert Report | Pakistan Asylum Evidence",
    content: [
  ...
  },
  {
    ...
    metaTitle: "Blasphemy Accusation Expert Report | Pakistan Asylum Reports",
    metaDescription:
      "Blasphemy accusation expert report for asylum tribunals. Sections 295 to 298 PPC, death penalty under s295-C, mob violence, police failures, and acquittal risk analysis.",
    h1: "Blasphemy Accusation Expert Report | Pakistan Asylum Evidence",
    content: [
  ...
  },
  {
    ...
    metaTitle: "Shia Muslim Expert Report | Pakistan Asylum Reports & Sectarian Risk",
    metaDescription:
      "Shia Muslim expert report for asylum tribunals. ASWJ and LeJ sectarian violence, Hazara persecution in Balochistan, July 2021 CPIN, and state protection analysis.",
    h1: "Shia Muslim Expert Report | Pakistan Asylum Evidence",
    content: [
  ...
  },
  {
    ...
    metaTitle: "Honour-Based Violence Expert Report | Pakistan Women Asylum Reports",
    metaDescription:
      "Women and honour-based violence expert report for asylum tribunals. Honour killings, forced marriage, police FIR failures, particular social group analysis, and internal relocation.",
    h1: "Women & Honour-Based Violence Expert Report | Pakistan",
    content: [
  ...
  },
  {
    ...
    metaTitle: "LGBTQ+ Asylum Pakistan Expert Report | s377 PPC & HJ (Iran)",
    metaDescription:
      "LGBTQ+ asylum from Pakistan expert report for tribunals. Section 377 PPC criminalisation, Khawaja Sira community, HJ (Iran) standard, and state protection analysis.",
    h1: "LGBTQ+ Asylum Expert Report | Pakistan Country Evidence",
    content: [
  ...
  },
  {
    ...
    metaDescription:
      "Political persecution expert report for asylum tribunals. PTI supporters post-2023 crackdown, journalists, enforced disappearances, Baloch nationalists, and military intelligence targeting.",
    h1: "Political Persecution Expert Report | Pakistan Asylum Evidence",
    content: [
  ...
  },
  {
    ...
    metaTitle: "Christian & Religious Minority Expert Report | Pakistan Asylum",
    metaDescription:
      "Christian and religious minority expert report for asylum tribunals. Blasphemy misuse, Jaranwala 2023 attacks, mob violence, Hindu and Sikh minority risk, and state protection failures.",
    h1: "Christian & Religious Minority Expert Report | Pakistan",
    content: [
  ...
  },
  {
    ...
    metaTitle: "Actors of Protection Pakistan Expert Report | State Protection Analysis",
    metaDescription:
    ...
    h1: "Actors of Protection Expert Report | Pakistan Country Evidence",
    content: [
