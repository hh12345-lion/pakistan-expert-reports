...
const btnPrimary =
  "inline-flex min-h-[44px] w-full items-center justify-center bg-[#801F37] px-5 py-2.5 text-sm font-semibold uppercase tracking-[0.1em] text-[#F2F5EF] transition hover:bg-[#65182c] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#801F37] sm:w-auto";
const btnSecondary =
...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl overflow-hidden border border-white/15 bg-[#191D18] shadow-[0_12px_40px_rgba(0,0,0,0.28)]">
        <div className="p-5 sm:p-6">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#A8AEA3]">
                Privacy &amp; compliance
              </p>
              ...
              <p id="cookie-banner-desc" className="mt-2 text-sm leading-relaxed text-white/82">
                ...
                <Link href="/cookie-policy" className="font-medium text-[#A8AEA3] hover:underline">
                  Cookie Policy
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="font-medium text-[#A8AEA3] hover:underline">
                  Privacy Policy
                </Link>
                .
              </p>
