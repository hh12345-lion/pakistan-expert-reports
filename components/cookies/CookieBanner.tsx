...
const btnPrimary =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-[4px] bg-[#2E7D52] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#256b42] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2E7D52] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0C3547] sm:w-auto";
const btnSecondary =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-[4px] border border-white/35 bg-white/5 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/12 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0C3547] sm:w-auto";
const btnGhost =
...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[8px] border border-[#C8DDD6]/25 bg-[#0C3547] shadow-[0_12px_40px_rgba(0,0,0,0.28)]">
        {/* Gold accent bar */}
        <div className="h-1 bg-gradient-to-r from-[#C8922A] via-[#2E7D52] to-[#C8922A]" aria-hidden />
